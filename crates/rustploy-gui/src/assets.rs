...
//! (`crates/rustploy-gui/styles/app.gss`, `crates/rustploy-gui/templates/app.kdl`,
//! `crates/shared/templates/blueprints/<id>/<logo>`) and from *inside* the KDL
//! themselves (`import ... from="crates/rustploy-gui/templates/service.kdl"`,
...
const MARKER: &str = "crates/rustploy-gui/templates/app.kdl";
