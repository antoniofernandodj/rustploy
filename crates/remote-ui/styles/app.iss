...
.login_card   { width: 460; background: #0D1117; border-radius: 16; border-width: 1; border-color: #21262D; padding: 32; spacing: 16; }
.login_title  { size: 30; bold: true; color: #A9C7FF; }
.field_label  { size: 11; bold: true; color: #8B949E; }
.field_input  { width: fill; padding: 13 14; }
.connect_btn  { width: fill; color: #2F81F7; padding: 14; }
